...
# ================== CẤU HÌNH ==================
TELEGRAM_BOT_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN", "8145981061:AAGIEx1zpY98lBkibA7yil7vQscwuxQIvag")
...
EMAIL_RECIPIENT = os.getenv("EMAIL_RECIPIENT", "tunguyen3214@gmail.com,ngoc.truong@vietcapital.com.vn,son.pham@vietcapital.com.vn,minh.tran@vietcapital.com.vn,tien.huynh@vietcapital.com.vn,diem.ngo@vietcapital.com.vn,vy.phan@vietcapital.com.vn,khanh.nguyen@vietcapital.com.vn,tam.nguyen@vietcapital.com.vn") # Email người nhận chính
            ...
            for page in range(1, 4):
                ...
                for article_link in list_soup.select(article_selector_str):
                    try:
                        ...
                        # LỌC TIÊU ĐỀ: Bỏ qua các bài viết có "VN-Index", "VNINDEX", "VN-INDEX"
                        if any(keyword in title.upper() for keyword in ["VN-INDEX", "VNINDEX", "VN-INDEX"]):
                            continue
